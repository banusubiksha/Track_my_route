...
//----------------------------------|
//Dental Hospital Fragment                |
//----------------------------------|
public class CooperqationbankFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private void searchNearbySchools() {
        ...
        String schoolType = "Corporation Bank";
