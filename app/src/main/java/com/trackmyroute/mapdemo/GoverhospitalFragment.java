...
//----------------------------------|
//Government Hospital Fragment                |
//----------------------------------|
public class GoverhospitalFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private void searchNearbySchools() {
        ...
        String schoolType = "government hospital";
