...
//Education Fragment                |
//----------------------------------|
public class CentralbankFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private void searchNearbySchools() {
        ...
        String schoolType = "Central Bank of India";
