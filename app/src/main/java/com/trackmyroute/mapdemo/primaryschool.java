...
//----------------------------------|
//primary_school Fragment                |
//----------------------------------|
public class primaryschool extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private void searchNearbySchools() {
        ...
        String schoolType = "primary school";
