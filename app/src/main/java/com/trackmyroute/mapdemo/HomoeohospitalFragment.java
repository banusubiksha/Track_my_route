...
//----------------------------------|
//Homoeohospital Fragment            |
//----------------------------------|
public class HomoeohospitalFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private void searchNearbySchools() {
        ...
        String schoolType = "homeopathic hospital";
